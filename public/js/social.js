...
const SOCIAL_ICON_META = {
  ...
  social_tiktok: {
    label: 'تيك توك',
    color: '#010101',
    svg: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="22" height="22"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.19a8.15 8.15 0 004.77 1.52V6.26a4.85 4.85 0 01-1-.57z"/></svg>`
  },
  social_telegram: {
    label: 'تلغرام',
    color: '#0088CC',
...
function renderSocialIcons(container, links, { size = 'w-12 h-12' } = {}) {
  ...
  container.innerHTML = entries
    ...
    <a href="${e.url}" target="_blank" rel="noopener" title="${e.label}"
       class="flex flex-col items-center gap-1 group" style="text-decoration:none">
      <span class="${size} rounded-full flex items-center justify-center transition-all group-hover:scale-110 group-hover:shadow-lg"
