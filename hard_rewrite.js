  ...
  <main class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="mb-12 rounded-lg bg-neutral-900 text-white overflow-hidden relative min-h-[250px] flex items-center">
      ...
      <div class="relative z-10 p-8 md:p-12 max-w-2xl">
        <span class="text-sm tracking-widest uppercase text-neutral-300 mb-2 block">تسوق الأفضل</span>
        <h1 class="text-3xl md:text-5xl font-bold leading-tight mb-4 text-white">كل ما تحتاجه،<br>بين يديك</h1>
        <p class="text-neutral-400 mb-8 max-w-md leading-relaxed text-sm md:text-base">اكتشف تشكيلتنا الواسعة من المنتجات، الملابس، والإكسسوارات. مجموعة مختارة بعناية لتناسب جميع أذواقك وتلبي كافة احتياجاتك اليومية.</p>
  ...
  <section class="bg-white border-t border-neutral-100 py-16 mt-12">
    <div class="max-w-4xl mx-auto px-4 text-center">
      ...
      <p class="text-neutral-500 leading-relaxed text-sm md:text-base max-w-2xl mx-auto">
        أوفارو هي وجهتك الأولى للتسوق الشامل. نحن نؤمن بتقديم تشكيلة واسعة ومتنوعة من الأزياء، الإكسسوارات، وأحدث المنتجات التي تواكب تطلعاتك. نسعى دائماً لتقديم أفضل جودة وخامات مميزة لتلبية كافة احتياجاتك اليومية ومنحك تجربة تسوق استثنائية.
      </p>
    </div>
  </section>
    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
        ...
        <div class="flex flex-col items-center md:items-start">
          ...
          <p class="text-neutral-500 text-sm leading-relaxed max-w-xs">نقدم لك تشكيلة واسعة من المنتجات المتنوعة بجودة عالية تلبي كل احتياجاتك.</p>
        </div>
      ...
      <div class="border-t border-neutral-200 pt-8 text-center">
        <p class="text-neutral-400 text-xs tracking-wider uppercase">&copy; <span id="currentYear"></span> OVARO STORE. All rights reserved.</p>
      </div>
    </div>
  </footer>
